...
/* 0x40 - 0x43*/	inc_eax, inv, inc_edx, inv,
/* 0x44 - 0x47*/	inv, inv, inc_esi, inc_edi,
/* 0x48 - 0x4b*/	dec_eax, dec_ecx, dec_edx, inv,
...
/* 0x60 - 0x63*/	push_a, pop_a, inv, inv,
/* 0x64 - 0x67*/	inv, inv, data_size_16, inv,
/* 0x68 - 0x6b*/	push_iv, imul_irm2r_v, push_ib, imul_i8rm2r_v,
...
/* 0x8c - 0x8f*/	inv, lea, mov_rm2sreg_w, inv,
/* 0x90 - 0x93*/	nop, xchg_r, xchg_r, xchg_r,
/* 0x94 - 0x97*/	xchg_r, xchg_r, xchg_r, xchg_r,
...
/* 0xec - 0xef*/	in_d2a_b, in_d2a_v,  out_a2d_b, inv,
...
{test_i2rm_v, inv, not_rm_v, neg_v, mul_rm2a_v, imul_rm2a_v, div_rm2a_v, idiv_rm2a_v};

/* 0xff */
instr_func group_5_indirect_entry[8] =
{incv, decv, call_mem, inv, jmp_far, inv, push_ev, inv};
